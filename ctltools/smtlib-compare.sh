...
usage() { echo "Usage: $INVOKENAME [OPTIONS ...] DUMPNAME1:DUMPNAME2 IDS"; }
help()
{
	usage
...
get_dumpnames()
{
	# TODO convert DUMPNAMEs to DUMPPATHs
	die_internal 'get_dumpnames(): dump names not implemented yet'
}
